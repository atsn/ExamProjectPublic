...
! function (A, B) {
    function C(C, g) {
        ...
        if (I === B && (I = 0), 0 === I) {
            ...
            g.fade ? !0 === g.fade ? g.fade = [400, 200] : "string" != typeof g.fade && "number" != typeof g.fade || (g.fade = [g.fade, g.fade]) : g.fade = [0, 0], C.data({
                LoadingOverlay: o,
    ...
    function g(C, g) {
        var Q = (C = A(C)).data("LoadingOverlayCount");
        if (Q !== B)
            if (Q-- , g || Q <= 0) {
