...
using SaleAndRentingPortalSql.Models.ManageViewModels;
using System;
using System.Linq;
using System.Text;
...
namespace SaleAndRentingPortalSql.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            model.City = dbContext.ZipCodes.Where(i => i.ZipCode == model.ZipCode).FirstOrDefault().City;
            return View(model);
        }
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            if (user == null)
            {
                throw new ApplicationException($"Kan ikke loade ID'{_userManager.GetUserId(User)}'.");
            }
           ...
           await _signInManager.SignInAsync(user, false);
            ...
            else
            {
                ...
                StatusMessage = "Der skete en fejl. Noget er gået galt.";
                return RedirectToAction(nameof(Index));
            }
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("SaleAndRentingPortalSql"),
